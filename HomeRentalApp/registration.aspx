<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registration.aspx.cs" Inherits="HomeRentalApp.registration" %>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="registration.aspx">Register</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <main class="page registration-page">
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <form id="form2" action="registration.aspx" method="post">
                    ...
                    <button class="btn btn-primary" type="submit" id="signup_btn">Sign Up</button>
                </form>
            </div>
        </section>
    </main>
